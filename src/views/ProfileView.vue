    ...
    <div class="row">
      <div class="col-md-3 border-right">
        <div class="d-flex flex-column align-items-center text-center p-3 py-5">
          ...
          <span class="font-weight-bold">{{this.userData["firstName"]}} {{this.userData["lastName"]}}</span>
          <span class="text-black-50">{{this.userData["email"]}}</span>
          <br>
          <span class="text-black-35">Balance:</span>
          <span class="text-black-50">{{this.userData["balance"]}} EUR</span>
      ...
      <div class="col-sm-4 mx-auto">
        ...
        <table>
          ...
          <tr class="break-word" v-for="product of products" :key="product.id">
            ...
            <router-link to="/"><button class="btn btn-link" aria-label="Remove product" v-on:click="productRemove(product.id)">
